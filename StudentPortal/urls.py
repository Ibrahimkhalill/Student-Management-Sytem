...
urlpatterns = [
    ...
    path('student_search', HodViews.student_search,name="student_search"),
    ...
    path('student_pdf/<str:student_id>', HodViews.student_information_pdf,name="student_pdf"),
    ...
    path('stud_profile', StudentViews.profile, name="stud_profile"),
